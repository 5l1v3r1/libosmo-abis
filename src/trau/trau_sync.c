...
static struct sync_pattern ts0861_amr8_low_pattern = {
	.name = "AMR8_LOW",
	.byte_pattern = {
		0x00, 0x80, 0x80, 0x40,
		0x80, 0x80, 0x80, 0x80,
...
static struct sync_pattern ts0861_amr8_67_pattern = {
	.name = "AMR8_67",
	.byte_pattern = {
		0x00, 0x80, 0x80, 0x80,
		0x80, 0x00, 0x80, 0x00,
...
static struct sync_pattern ts0861_amr8_74_pattern = {
	.name = "AMR8_74",
	.byte_pattern = {
		0x20, 0x00, 0x80, 0x00,
		0x00, 0x00, 0x00, 0x00,
...
{
	sync_pattern_register(&ts0860_fr_pattern);
	sync_pattern_register(&ts0861_hr8_pattern);
	sync_pattern_register(&ts0861_amr8_low_pattern);
	sync_pattern_register(&ts0861_amr8_67_pattern);
	sync_pattern_register(&ts0861_amr8_74_pattern);
